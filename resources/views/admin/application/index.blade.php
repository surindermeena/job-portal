				 	...
				 	<div class="col-lg-9 column">
				 		<div class="padding-left">
					 		<div class="manage-jobs-sec">
					 			<h3>All Applications <a href="{{ url()->previous() }}" class="btn btn-primary mx-2 my-2 float-right">Back</a></h3>
						 		<table >
						 			<thead>
						 				<tr>
						 				...
						 				<tr>
											<td>
												<div class="table-list-title">
													<h3><a href="#" title="">{{$data->candidate->user->name}}</a></h3>
												</div>
											</td>
											<td>
												<div class="table-list-title">
													<h3><a href="#" title="">{{$data->job->job_title}}</a></h3>
												</div>
											</td>
						 					<td>
						 						<ul class="action_job">
