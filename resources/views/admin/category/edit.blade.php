						...
						<div class="padding-left">
							<div class="profile-title">
								<div style="margin:20px"> 
									<h3 class="fw-bold">Edit Category <a href="{{ url()->previous() }}" class="btn btn-primary mx-2 my-2 float-right">Back</a></h3>
								</div>
							</div>
...
@push('scripts')
<script>
document.getElementById('formA2').addEventListener('submit', async function (e) {
    e.preventDefault();
    ...
    try {
        const response = await fetch('{{ route("admin.category.update", $data->id) }}', {
